...
namespace AquaUI.Data.Bindings
{
    ...
    public sealed class Binding : IBinding
    {
        ...
        /// You'll need to call <see cref="DependencyObject.Bind(IBinding)"/>
        ...
        /// <summary>
        /// Gets or sets a value defining the direction of the bining.
        /// </summary>
        ...
        {
            var value = Path.GetValue(Source);
