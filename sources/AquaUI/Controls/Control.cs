...
namespace AquaUI.Controls
{
    ...
    public class Control : UIElement, ITransformable, IBindingTarget, INotifyFocusChanged, INotifyPropertyChanged
    {
        /// <summary>
        ...
        protected internal virtual void ResetDataContext()
        {
            ...
            {
                if (Desktop != null && binding.SourcePath != null)
                {
                    binding.Source = Desktop.GetControlByName(binding.SourcePath) ?? newDataContext;
                }
                else
                {
