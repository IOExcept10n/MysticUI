...
namespace AquaUI.Controls
{
    ...
    public class Selector : SingleItemControlBase<ToggleButton>, IContainerControl
    {
        ...
        private void ListBox_ButtonClick(object? sender, GenericEventArgs<ItemsControl.ButtonClickContext> e)
        {
            HideDropdown();
        }
        ...
        private void Desktop_ContextMenuClosed(object? sender, GenericEventArgs<Control> e)
        {
