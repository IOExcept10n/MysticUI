...
namespace AquaUI.Assets
{
    ...
    public interface IResourceRegistry : IDictionary<string, object>
    {
        ...
        /// <summary>
        /// Tries to load the resources file and register all the associated resources.
        /// </summary>
        /// <param name="resourcesFileStream">Stream to the resources data to load.</param>
        void LoadResources(Stream resourcesFileStream);
    }
}