...
namespace Icy.MonoGame.Assets
{
    ...
    internal class AssemblyResourceContext : MonoGameAssetContext
    {
            ...
            : base(rootPath)
        {
            ...
            {
                sourceAssembly = resolver.FindAssembly(RootPath.Authority) ?? resolver.DefaultAssembly;
            }
            else
            {
                sourceAssembly = resolver.DefaultAssembly;
            }
        }
        ...
        /// <inheritdoc/>
        public override MonoGameAssetContext Combine(string relativePath) => new AssemblyResourceContext(new(RootPath, relativePath), AssemblyResolver);
